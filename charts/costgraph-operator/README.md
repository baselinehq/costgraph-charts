...
| rbac | object | `{"builtinAPIGroups":["apps","autoscaling","batch","discovery.k8s.io","networking.k8s.io","policy","storage.k8s.io"],"customResourceAPIGroups":["argoproj.io","cilium.io","crd.k8s.amazonaws.com","eks.amazonaws.com","elbv2.k8s.aws","externaldns.k8s.io","gateway.networking.k8s.io","image.toolkit.fluxcd.io","karpenter.azure.com","karpenter.k8s.aws","karpenter.sh","kustomize.toolkit.fluxcd.io","monitoring.coreos.com","networking.k8s.aws","postgresql.cnpg.io","source.toolkit.fluxcd.io","vpcresources.k8s.aws"],"discoverAdditionalAPIGroups":true,"excludeAPIGroups":["acme.cert-manager.io","authentication.k8s.io","authorization.k8s.io","cert-manager.io","certificates.k8s.io","external-secrets.io","generators.external-secrets.io","helm.toolkit.fluxcd.io","notification.toolkit.fluxcd.io","rbac.authorization.k8s.io","traefik.io","velero.io","admissionregistration.k8s.io","apiextensions.k8s.io","apiregistration.k8s.io","coordination.k8s.io","events.k8s.io","flowcontrol.apiserver.k8s.io","internal.apiserver.k8s.io","longhorn.io","metrics.k8s.io","node.k8s.io","scheduling.k8s.io","storagemigration.k8s.io"],"extraRules":[],"grantCustomResources":true}` | ------------------------------------------------------------------------ |
