...
| nameOverride | string | `""` |  |
| operatorKubernetes | object | `{"affinity":{},"config":{"operatorVersion":"1.0.0","remoteWritePath":"","remoteWriteURL":""},"enabled":true,"env":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/baselinehq/costgraph-operator-kubernetes","tag":"v0.1.0"},"nodeSelector":{},"podAnnotations":{},"podLabels":{},"replicas":1,"resources":{"requests":{"cpu":"10m","memory":"64Mi"}},"securityContext":{},"tolerations":[]}` | ------------------------------------------------------------------------ |
